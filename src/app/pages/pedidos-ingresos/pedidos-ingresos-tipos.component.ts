...
@Component({
  selector: 'app-pedidos-ingresos-tipos',
  templateUrl: './pedidos-ingresos-tipos.component.html',
  styles: [
  ]
})
export class PedidosIngresosTiposComponent implements OnInit {
  ...
  constructor(private tiposService: MayoristasTiposIngresosService,
